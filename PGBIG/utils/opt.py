...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--dct_n_lay5', type=int, default=15, help='future frame number downsam 5')
        self.parser.add_argument('--lay5_inter', type=int, default=5, help='layer inter 5frame')
