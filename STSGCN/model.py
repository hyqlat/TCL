...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        # self.txcnns.append(CNN_layer(output_time_frame,output_time_frame + 1,txc_kernel_size,txc_dropout))#####
    ...
    def forward(self, x):
        ...
        #x: B T 3 D
        ba, _, _,_ = x.shape
        alpha_cal = self.cal_alpha(x.view(ba, -1))#B T 3D

        return x, alpha_cal#B 1
