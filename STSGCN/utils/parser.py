...
parser.add_argument('--data_dir',type=str,default='/data1/jianwei/yanjiu/STSGCN/dataset/',help='path to the unziped dataset directories(H36m/AMASS/3DPW)')
...
parser.add_argument('--milestones',type=list,default=[15,25,35,40, 60],help= 'the epochs after which the learning rate is adjusted by gamma')
parser.add_argument('--gamma',type=float,default=0.8,help= 'gamma correction to the learning rate, after reaching the milestone epochs')
